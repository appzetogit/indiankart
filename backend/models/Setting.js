...
const settingSchema = mongoose.Schema({
    ...
    ekartClientId: { type: String, default: '' },
    ...
    ekartCreateShipmentPath: { type: String, default: '/api/v1/package/create' },
    ekartTrackingPath: { type: String, default: '/api/v1/track/{id}' },
